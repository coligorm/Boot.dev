...
Call .area() on any shape, without caring which kind it is
Use + between shapes to build a CompositeShape
Call .area() on a CompositeShape to get the total area of all its shapes
